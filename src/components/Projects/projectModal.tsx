...
const ProjectCardModal: React.FC<CardProps> = ({ title, content, image, description, gitHubLink, link, techStack, modalOpen, setModalOpen }) => {
    console.log(title,content,image,description,gitHubLink,link,techStack, modalOpen)
